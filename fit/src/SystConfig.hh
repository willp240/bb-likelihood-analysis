...
public:
  ...
  void AddParameter(const std::string& name_, double nom_, double min_, double max_, double mass_, double sigma_, int nbins_, double constrMean_, double constrSigma_, const std::string& obs_, const std::string& type_);
  ...
  void AddParameter(const std::string& name_, double nom_, double min_, double max_, double mass_, double sigma_, int nbins_, double constrMean_, double constrSigma_, const std::string& obs_, const std::string& type_, double nom_stddev_, double min_stddev_, double max_stddev_, double mass_stddev_, double sigma_stddev_, int nbins_stddev_);
